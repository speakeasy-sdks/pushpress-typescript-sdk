...
import {
  ...
  GetAppInstallRequest$outboundSchema,
} from "../models/operations/getappinstall.js";
...
> {
  const parsed = safeParse(
    request,
    (value) => GetAppInstallRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, AppInstall$inboundSchema),
