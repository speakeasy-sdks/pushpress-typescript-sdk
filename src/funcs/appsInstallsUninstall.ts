...
import {
  UninstallAppRequest,
  UninstallAppRequest$outboundSchema,
} from "../models/operations/uninstallapp.js";
import { Result } from "../types/fp.js";

/**
 * Soft uninstall an app (mark it as uninstalled but retain data)
 */
export async function appsInstallsUninstall(
...
> {
  const parsed = safeParse(
    request,
    (value) => UninstallAppRequest$outboundSchema.parse(value),
