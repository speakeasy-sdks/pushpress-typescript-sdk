...
import {
  ...
  ListAppInstallsRequest$outboundSchema,
  ListAppInstallsResponse,
  ListAppInstallsResponse$inboundSchema,
...
> {
  const parsed = safeParse(
    request,
    (value) => ListAppInstallsRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, ListAppInstallsResponse$inboundSchema, { key: "Result" }),
