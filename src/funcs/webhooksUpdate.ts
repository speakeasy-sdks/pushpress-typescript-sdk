...
} from "../models/components/webhook.js";
...
import {
  ...
  UpdateWebhookRequest$outboundSchema,
} from "../models/operations/updatewebhook.js";
...
> {
  const parsed = safeParse(
    request,
    (value) => UpdateWebhookRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, Webhook$inboundSchema),
