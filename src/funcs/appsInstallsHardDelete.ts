...
} from "../models/components/appinstall.js";
...
import {
  ...
  DeleteAppInstallRequest$outboundSchema,
} from "../models/operations/deleteappinstall.js";
import { Result } from "../types/fp.js";

/**
 * Hard delete an app (remove all data)
 */
export async function appsInstallsHardDelete(
...
> {
  const parsed = safeParse(
    request,
    (value) => DeleteAppInstallRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(204, AppInstall$inboundSchema),
