...
} from "../models/components/checkin.js";
...
import {
  GetCheckinRequest,
  GetCheckinRequest$outboundSchema,
} from "../models/operations/getcheckin.js";
...
> {
  const parsed = safeParse(
    request,
    (value) => GetCheckinRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, Checkin$inboundSchema),
