...
import { ApiKey, ApiKey$inboundSchema } from "../models/components/apikey.js";
...
import {
  GetApiKeyRequest,
  GetApiKeyRequest$outboundSchema,
} from "../models/operations/getapikey.js";
...
> {
  const parsed = safeParse(
    request,
    (value) => GetApiKeyRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, ApiKey$inboundSchema),
